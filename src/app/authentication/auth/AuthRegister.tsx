    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                else if (data.error === 'Email has been registered before but deleted. Please Contact Admin!') {
                    setErrors({ ...errors, email: 'Email has been registered before but deleted. Please Contact Admin!' });
                    throw new Error('Email has been registered before but deleted. Please Contact Admin!');
                } 
